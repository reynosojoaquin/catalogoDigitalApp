...
import suplidorController from '../controllers/SuplidorController';
...
router.get('/', suplidorController.getAll);
router.get('/:id', suplidorController.getById);
router.put('/:id', suplidorController.update);
router.post('/', suplidorController.create);
router.delete('/:id', suplidorController.delete);
