...
import TipoDireccionController from '../controllers/tipoDireccionController';
...
router.get('/', TipoDireccionController.getAll);
router.get('/:id', TipoDireccionController.getById);
router.put('/:id', TipoDireccionController.update);
router.post('/', TipoDireccionController.create);
router.delete('/:id', TipoDireccionController.delete);
