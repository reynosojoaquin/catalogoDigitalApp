...
router.get('/', bancaController.getAll);
router.get('/:id', bancaController.getById);
router.put('/:id', bancaController.update);
router.post('/', bancaController.create);
router.delete('/:id', bancaController.delete);
