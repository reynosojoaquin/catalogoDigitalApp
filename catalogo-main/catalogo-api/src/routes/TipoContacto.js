...
import tipoContactoController from '../controllers/tipoContactoController';
...
router.get('/', tipoContactoController.getAll);
router.get('/:id', tipoContactoController.getById);
router.put('/:id', tipoContactoController.update);
router.post('/', tipoContactoController.create);
router.delete('/:id', tipoContactoController.delete);
